...
public class Login extends JFrame implements ActionListener, ItemListener, WindowListener{
...
//		userdao.inputUser();
		...
		lblNewLabel_2.setFont(new Font("华文隶书", Font.PLAIN, 16));
		lblNewLabel_2.setHorizontalAlignment(SwingConstants.CENTER);
		
		JLabel lblNewLabel_3 = new JLabel("密码：");
		lblNewLabel_3.setFont(new Font("华文隶书", Font.PLAIN, 16));
